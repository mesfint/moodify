...
const Sidebar = () => (
  <>
    ...
    <aside className="hidden lg:flex w-64 sticky top-0 h-screen overflow-y-auto scrollbar-hidden flex-col gap-2 px-2 bg-secondary-dark text-secondary-text-light">
